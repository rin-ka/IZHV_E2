...
/// +code
    ...
    /// <summary>
    /// How often (in seconds) the obstacle speed increases.
    /// </summary>
    public float speedIncreaseInterval = 10.0f;

    /// <summary>
    /// How much to multiply the speed each interval.
    /// </summary>
    public float speedMultiplier = 1.1f;

    /// <summary>
    /// Tracks the time since the last speed increase.
    /// </summary>
...
/// +code
    ...
    void Update()
    {
        ...
        if (speedIncreaseTimer >= speedIncreaseInterval)
        {
            ...
            sp.ModifyObstacleSpeed(speedMultiplier);  // Increase the speed of all objects
    }
